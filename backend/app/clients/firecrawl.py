...
_EXTRACT_PROMPT = (
    ...
    "Images: ONLY the gallery of the MAIN product on the page, in this exact "
    "colorway — never thumbnails of recommended/similar products, other "
    "colorways, or navigation imagery. "
